...
public class Constant {
    public static class API{
        ...
        public static final String cartItem         = baseUrl + "market/cartItem";
        public static final String clearCart        = baseUrl + "market/cartItem/empty";
        public static final String search           = baseUrl + "market/front/shops/products";
        public static final String selectProduct    = baseUrl + "market/cartItem/select";
        public static final String selectShop       = baseUrl + "market/cartItem/select/shop";
    }
}
